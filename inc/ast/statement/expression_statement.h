#ifndef CODECRAFTERS_INTERPRETER_EXPRESSION_STATEMENT_H
#define CODECRAFTERS_INTERPRETER_EXPRESSION_STATEMENT_H
...
struct ExpressionStatement : Node {
  ExpressionStatement(const lexer::Token &token,
